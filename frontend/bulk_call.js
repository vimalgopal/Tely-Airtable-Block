    ...
    async function sendSms() {
      ...
      for (let j = 0; j <= messageObj.phone.length; j++) {
        if (messageObj.phone[j]) {
          ...
          let url = encodeURI(
            "https://sheetify.aeroapps.xyz/getxml?message=" +
              messageObj.sms_text[j]
          );
...
class BULK_CALL extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      page: "",
    ...
    return (
      <div style={{ padding: "10px" }}>
        ...
        <div style={{ textAlign: "center" }}>
          <h4>Make Multiple Voice Messages</h4>
